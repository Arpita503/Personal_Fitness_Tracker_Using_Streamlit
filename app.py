...
@st.cache_data
def load_data():
    calories = pd.read_csv(r"C:\Users\hp\OneDrive\Desktop\Personal_Fitness_tracker\calories.csv")
    exercise = pd.read_csv(r"C:\Users\hp\OneDrive\Desktop\Personal_Fitness_tracker\exercise.csv")
